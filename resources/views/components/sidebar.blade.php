            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuthentication">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item"><a href="auth-signin.html" class="nav-link"><i
                                        class="las la-user-tie"></i> My Direct Business</a></li>
                            <li class="nav-item"><a href="auth-signup.html" class="nav-link"><i
                                        class="las la-user-friends"></i> My Downline Business</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-sitemap"></i> Geneology</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarFunds">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item"><a href="auth-signup.html" class="nav-link"><i
                                        class="las la-chart-pie"></i> Fund Summary</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-hand-holding-usd"></i> Fund Request</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-clipboard-list"></i> Fund Request Status</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-history"></i> Fund History</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-exchange-alt"></i> Fund TRansfer</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-list"></i> Fund List</a></li>
                            <li class="nav-item"><a href="auth-pass-reset.html" class="nav-link"><i
                                        class="las la-inbox"></i> Fund Receive List</a></li>
                        </ul>
                    </div>
                </li>
